...
public class Cognito {
    ...
    public Cognito(Context context){
        appContext = context;
        userPool = new CognitoUserPool(context, SecurityApplication.COGNITO_USER_POOL_ID,
        SecurityApplication.ID,
        SecurityApplication.SECRET,
        Regions.US_EAST_1);
...
//
        ...
        public void onSuccess(CognitoUser user, SignUpResult signUpResult) {
            Log.e(SecurityApplication.TAG, "" + user + "\n\n\n" + signUpResult);
        }
